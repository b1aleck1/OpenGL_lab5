...
# Tablice na wierzchołki i wektory normalne
...
def startup():
    ...
    # Konfiguracja materiałów i światła
...
def render(time):
    ...
    # Aktualizacja kątów (ruch światła)
    if left_mouse_button_pressed:
        theta -= delta_x * pix2angle  # Odwrócone dla intuicyjnego sterowania
    ...
    # RYSOWANIE JAJKA Z WEKTORAMI NORMALNYMI
...
def main():
    ...
    window = glfwCreateWindow(400, 400, "Lab 5 (Ocena 4.5)", None, None)
    if not window:
        glfwTerminate()
        sys.exit(-1)
